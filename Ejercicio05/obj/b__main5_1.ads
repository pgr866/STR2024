...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main5_1" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#7f924ffe#;
   pragma Export (C, u00001, "main5_1B");
   ...
   u00121 : constant Version_32 := 16#d47184a6#;
   pragma Export (C, u00121, "numeros_complejosB");
   u00122 : constant Version_32 := 16#7a9edd19#;
