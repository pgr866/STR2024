...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main4_1" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b24585ba#;
   pragma Export (C, u00001, "main4_1B");
   ...
   u00121 : constant Version_32 := 16#2913aa1c#;
   pragma Export (C, u00121, "colaB");
   u00122 : constant Version_32 := 16#0e6e41a7#;
